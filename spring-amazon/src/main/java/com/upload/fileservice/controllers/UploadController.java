package com.upload.fileservice.controllers;

import com.upload.fileservice.domain.Upload;
import com.upload.fileservice.service.UploadService;
...
public class UploadController {
    ...
    @GetMapping
    public ResponseEntity<List<Upload>> getTodos() {
    ...
    public ResponseEntity<Upload> saveTodo(@RequestParam("title") String title,
